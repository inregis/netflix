...
console.log('✅ Card.js carregado');

export function createCard(item) {
    try {
        console.log('🎥 createCard chamado para:', item.img?.substring(0, 50));
        ...
        console.log('🎬 ID do YouTube:', videoId);
        ...
        // Retornar um card vazio para evitar quebra total
        const card = document.createElement('div');
        card.className = 'movie-card';
        card.innerHTML = '<p style="padding: 20px; color: red;">Erro ao carregar card</p>';
        return card;
    }
}
